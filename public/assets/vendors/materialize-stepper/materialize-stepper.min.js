  ...
  function E(e) {
    ...
    _classCallCheck(this, E),
      _defineProperty(this, "_init", function () {
        var e = m._formWrapperManager,
          t = m.getSteps,
          n = m.options,
          i = m.stepper,
          r = m.classes,
          s = m._methodsBindingManager,
          o = m._openAction;
        (m.form = e()),
          o(t().steps[n.firstActive], void 0, void 0, !0),
          s(i.querySelectorAll(".".concat(r.STEP)));
      }),
      _defineProperty(this, "_methodsBindingManager", function (e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
          o = m.classes,
          a = m._formSubmitHandler,
          l = m._nextStepProxy,
          c = m._prevStepProxy,
          p = m._stepTitleClickHandler,
          d = m.form,
          v = m.options,
          n = E.nodesIterator,
          f = E.tabbingDisabler,
      ...
      _defineProperty(this, "_formSubmitHandler", function (e) {
        m._validationFunctionCaller() || e.preventDefault();
      }),
      _defineProperty(this, "resetStepper", function () {
        m.form && (m.form.reset(), m.openStep(m.options.firstActive));
      }),
      ...
      _defineProperty(this, "_closeAction", function (e, n) {
        var t = m._slideUp,
          ...
          r = m.stepper,
          s = m.events,
          o = m._smartListenerUnbind,
          a = m._smartListenerBind,
      ...
      _defineProperty(this, "_nextStepProxy", function (e) {
        return m.nextStep(void 0, void 0, e);
      }),
      _defineProperty(this, "_prevStepProxy", function (e) {
        return m.prevStep(void 0, e);
      }),
      ...
      _defineProperty(this, "nextStep", function (e, t, n) {
        ...
        return E && !f()
          ? a()
          : P && !t
          ? (u && !y.step.dataset.nopreloader && s(),
            void window[P](
              v,
              o,
              y.step.querySelector(".".concat(l.STEPCONTENT))
            ))
          : (y.step.classList.add(l.DONESTEP),
            c(h, e),
        ...
        var t =
          ...
          s = function e(t) {
            "height" === t.propertyName &&
              (m._smartListenerUnbind(n, "transitionend", e),
            ...
            (n.style.display = "none"),
              requestAnimationFrame(function () {
                (n.style.overflow = "hidden"),
                  ...
                  requestAnimationFrame(function () {
                    m._smartListenerBind(n, "transitionend", s),
                      (n.style.height = r),
