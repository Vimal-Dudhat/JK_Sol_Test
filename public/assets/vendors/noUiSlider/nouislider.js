...
(function () {
    ...
    for (f = 0; f < h.length; f += 1)
      (c = h[f]),
        ...
        void 0 === d
          ...
          : "decimals" === c
          ? 0 < d && 8 > d && (e[c] = d)
          : "encoder" === c || "decoder" === c || "edit" === c || "undo" === c
          ? "function" === typeof d && (e[c] = d)
  ...
  var h =
    "decimals thousand mark prefix postfix encoder decoder negativeBefore negative edit undo".split(
      " "
    );
  window.wNumb = t;
})();
