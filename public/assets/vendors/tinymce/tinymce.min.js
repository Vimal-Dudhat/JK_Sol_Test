...
!(function () {
  ...
  var fe,
    de = {
      ...
      android: g,
      contentEditable:
        !m || p || 534 <= parseInt(ce.match(/AppleWebKit\/(\d*)/)[1], 10),
      transparentSrc:
    ...
    Ee = function (e, t) {
      ...
      return (
        ...
        !(o.stopImmediatePropagation = function () {
          ...
          ((r = o).isDefaultPrevented === xe || r.isDefaultPrevented === Ce) &&
          ((o.isDefaultPrevented = Ce),
          (o.isPropagationStopped = Ce),
          (o.isImmediatePropagationStopped = Ce)),
    ...
    Se = function (e, t, n) {
      ...
      if (n.domLoaded) t(o);
        ...
        !r.addEventListener || (de.ie && de.ie < 11)
            ...
            if (((s = y[r]), t)) {
              for (i = (t = t.split(" ")).length; i--; )
                if ((o = s[(u = t[i])])) {
                  ...
                  (n && 0 !== o.length) ||
                    (delete s[u],
                    Ne(e, o.fakeName || u, o.nativeHandler, o.capture));
                }
            } else {
              for (u in s)
                (o = s[u]), Ne(e, o.fakeName || u, o.nativeHandler, o.capture);
              s = {};
            }
            for (u in s) return b;
            delete y[r];
  ...
  var kt = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : We) !== ze && Fe(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
    ...
    if (Ve && !r) {
      if ((o = xt.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && Ae.getElementsByClassName)
  ...
  function Tt() {
    ...
    return function e(t, n) {
      return (
        r.push(t + " ") > Re.cacheLength && delete e[r.shift()],
        (e[t + " "] = n)
      );
    };
  }
                  ...
                  (1 &
                    (n =
                      (e.ownerDocument || e) === (t.ownerDocument || t)
                        ...
                        : 1) ||
                  (!Ae.sortDetached && t.compareDocumentPosition(e) === n)
  ...
  (kt.matchesSelector = function (e, t) {
    if (
      ...
      (t = t.replace(gt, "='$1']")),
      Ae.matchesSelector && Ve && (!je || !je.test(t)) && (!He || !He.test(t)))
    )
      try {
        var n = (void 0).call(e, t);
        if (
          n ||
          Ae.disconnectedMatch ||
  ...
  (kt.attr = function (e, t) {
    ...
    var n = Re.attrHandle[t.toLowerCase()],
      r =
        n && et.call(Re.attrHandle, t.toLowerCase()) ? n(e, t, !Ve) : undefined;
    return r !== undefined
      ? r
      : Ae.attributes || !Ve
      ? e.getAttribute(t)
  ...
  (kt.uniqueSort = function (e) {
    var t,
      ...
      o = 0;
    if (
      ((Me = !Ae.detectDuplicates),
      (Ie = !Ae.sortStable && e.slice(0)),
      e.sort(Qe),
      Me)
    ) {
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Ve &&
            Re.relative[i[1].type]
          ) {
            if (!(t = (Re.find.ID(a.matches[0].replace(Et, St), t) || [])[0]))
              return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (
            o = vt.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !Re.relative[(u = a.type)]);
        ...
        return (
          (c || Oe(e, l))(r, t, !Ve, n, (wt.test(e) && Ot(t.parentNode)) || t),
          n
        );
      }),
  ...
  var Sn,
    ...
    wr = function (e, t) {
      var n,
        ...
        a =
          "" !== i ||
          ((r = lr((n = e)) ? n.dom().parentNode : n.dom()) !== undefined &&
            null !== r &&
    ...
    Br = function (e) {
      return (
        (e.nodeType !== Rr && e.nodeType !== _r) || 0 === e.childElementCount
      );
    },
    Or = function (e, t) {
      return e.dom() === t.dom();
      ...
      getPos: function (e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            n === e &&
            t.getBoundingClientRect &&
            "static" === wr(rr.fromDom(e), "position")
          )
            return {
              x: (a =
                (o = t.getBoundingClientRect()).left +
        ...
        return e.replace(Fo, function (e, t) {
          return t
            ...
            : ao[e] ||
                oo[e] ||
                ((n = e),
                ((r = rr.fromTag("div").dom()).innerHTML = n),
  ...
  function ti(i) {
    var e,
      ...
      v = function (e, t, n) {
        ...
        return (
          r
            ? (r = Ko(r, /[, ]/, Ko(r.toUpperCase(), /[, ]/)))
            : (r = $o[e]) ||
              ((r = Ko(t, " ", Ko(t.toUpperCase(), " "))),
              (r = Yo(r, n)),
              ($o[e] = r)),
          r
        );
        ...
        e &&
          ...
          Xo(Qo(e, ","), function (e) {
            ...
            if (
              ...
              var i = N[r];
              delete (i = Yo({}, i)).removeEmptyAttrs,
            ...
            if (
              ...
              "font-weight" === n && "700" === r
                ...
                : ("color" !== n && "background-color" !== n) ||
                  (r = r.toLowerCase()),
                (r = (r = r.replace(x, ni)).replace(w, b)),
                (c[n] = o ? p(r, !0) : r);
            }
          d("border", "", !0),
            d("border", "-width"),
            ...
            (u = function () {
              ...
              if (
                ...
                (a.length = 0),
                  hi(t, function (e) {
                    0 === s.length
                      ? bi(e.success) && e.success.call(e.scope)
                      : bi(e.failure) && e.failure.call(e.scope, s);
                  });
              }
            })();
        });
  ...
  var Ni = function (t, n) {
    ...
    Fi = function (e) {
      0 === (Pi(e) ? e.dom().classList : Oi(e, "class")).length &&
        yr(e, "class");
    },
    zi = function (e, t) {
    ...
    Vi = function (e, t) {
      return (
        ...
        Br(o) ? [] : $(o.querySelectorAll(n), rr.fromDom)
      );
      var n, r, o;
    };
  ...
  var ji,
    ...
    Ki = function (e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? document : r.dom()),
        Br(o) ? A.none() : A.from(o.querySelector(n)).map(rr.fromDom)
      );
      var n, r, o;
    },
    Xi = function (e, t, n) {
    ...
    ta = function (e, n) {
      e.on("init", function () {
        e.serializer.addNodeFilter("span", function (e) {
          F(e, function (t) {
            var e;
            ((e = t), A.from(e.attributes.map[Gi()]).bind(n.lookup)).each(
              function (e) {
    ...
    ma = function (e) {
      return (
        da(e) && (e = e.parentNode), fa(e) && e.hasAttribute("data-mce-caret")
      );
    },
    ga = function (e) {
    ...
    Da = function (e) {
      return (
        !_a(e) && (ka(e) ? !Ta(e.parentNode) : Aa(e) || Sa(e) || Ra(e) || Ba(e))
      );
    },
    Ba = function (e) {
      return (
        !1 ===
          ((t = e),
          _o.isElement(t) && "true" === t.getAttribute("unselectable")) && Ea(e)
      );
      var t;
    },
    Oa = function (e, t) {
      ...
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              ja(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !uu(n))
            )
              return o(lu(cu(n), !1)), r;
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), uu(n) || o(lu(cu(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), uu(n) || o(lu(cu(n), !0)));
        };
      if (eu(e.container())) return i(e.container(), e.offset()), r;
      if (Xa(e.container()))
        if (e.isAtEnd())
          (n = ru(e.container(), e.offset())),
            eu(n) && i(n, n.data.length),
            Qa(n) && !tu(n) && o(lu(cu(n), !1));
        else {
          if (
            ((n = ru(e.container(), e.offset())),
            eu(n) && i(n, 0),
            ...
            return o(lu(cu(n), !1)), r;
          (t = ru(e.container(), e.offset() - 1)),
            Qa(t) && !tu(t) && (Ga(t) || Ga(n) || !Qa(n)) && o(lu(cu(t), !1)),
            Qa(n) && o(lu(cu(n), !0));
        }
      return r;
    };
  ...
  var mu,
          ...
          (r = qt.reduce(
            ...
            ? vu(r)
              ? (function (e, t) {
                  ...
                  return (
                    vu(e) && t > e.data.length && (t = e.data.length), hu(e, t)
                  );
                })(r, parseInt(o, 10))
    ...
    Bu = function (e, t) {
      ...
      if (pa(e)) {
        if (
          (_o.isText(e) && ma(e) && (e = e.parentNode),
          (n = e.previousSibling),
          ku(n))
        )
          return n;
    ...
    Ou = function (e, t, n) {
      ...
      var a,
        ...
        d,
        m =
          Bu((a = i).startContainer, a.startOffset) ||
          Bu(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: Ru(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
          ((d = {}).start = Tu(f, u, c, l, !0)),
          s.isCollapsed() || (d.end = Tu(f, u, c, l, !1)),
          d);
    },
    Pu = function (e, t, n) {
      var r = {
    ...
    Ku = function (e, t) {
      return Vu(e) && t.container() === e
        ? ((r = t),
          (o = qu((n = e).data.substr(0, r.offset()))),
          (i = qu(n.data.substr(r.offset()))),
          0 < (a = o.text + i.text).length
            ? (ju(n, a), hu(n, r.offset() - o.count))
            : r)
        : $u(e, t);
      var n, r, o, i, a;
    },
    Xu = function (e) {
      if (
        (Uu(e) &&
          pa(e) &&
          (ha(e) ? e.removeAttribute("data-mce-caret") : Hu(e)),
        Vu(e))
      ) {
        var t = la(
          (function (e) {
    ...
    Yu = {
      removeAndReposition: function (e, t) {
        return hu.isTextPosition(t)
          ? Ku(e, t)
          : ((n = e),
            (r = t).container() === n.parentNode ? Wu(n, r) : $u(n, r));
        var n, r;
      },
      remove: Xu,
    },
    ...
    Zu = function (a, u, e) {
      ...
      return {
        show: function (t, e) {
          var n, r, o;
          if ((l(), (o = e), _o.isElement(o) && /^(TD|TH)$/i.test(o.tagName)))
            return null;
          if (!u(e))
            return (
              (s = (function (e, t) {
                var n, r, o;
                if (
                  ((r = e.ownerDocument.createTextNode(ca)),
                  (o = e.parentNode),
                  t)
                ) {
    ...
    ws = function (e, t, n) {
      ...
      if (_o.isText(o)) {
        ...
        if (xa(o) && i >= o.data.length - 1)
          return 1 === e && (r = s(o)) ? Cs(r) : n;
  ...
  ((pu = gu || (gu = {}))[(pu.Backwards = -1)] = "Backwards"),
    (pu[(pu.Forwards = 1)] = "Forwards");
  var Ls,
    Is,
    Ms,
    Fs,
    ...
    Xs = function (e, t) {
      if (fs(e)) {
        if (qs(t.previousSibling) && !Vs(t.previousSibling))
          return hu.before(t);
    ...
    Ys = function (e, t, n) {
      ...
      if (t.isEqual(hu.after(n)) && n.lastChild) {
        if (
          ((u = hu.after(n.lastChild)),
          ds(e) && qs(n.lastChild) && Hs(n.lastChild))
        )
          return js(n.lastChild) ? hu.before(n.lastChild) : u;
      } else u = t;
      var s,
        c,
        l,
      ...
      if (Vs(f)) {
        ...
        if (ds(e) && 0 < d && ((o = Ks(f, d - 1)), qs(o)))
          return !$s(o) && (i = gs(o, e, Ws, o))
            ? Vs(i)
              ? hu(i, i.data.length)
              : hu.after(i)
            : Vs(o)
        ...
        if (fs(e) && d < f.childNodes.length && ((o = Ks(f, d)), qs(o)))
          return js(o)
            ? ((s = n),
              (l = (c = o).nextSibling) && qs(l)
                ? Vs(l)
                  ? hu(l, 0)
                  : hu.before(l)
                : Ys(gu.Forwards, hu.after(c), s))
            : !$s(o) && (i = gs(o, e, Ws, o))
            ? Vs(i)
              ? hu(i, 0)
              : hu.before(i)
      ...
      return ((fs(e) && u.isAtEnd()) || (ds(e) && u.isAtStart())) &&
        ((r = gs(r, e, j(!0), n, !0)), Ws(r, n))
        ? Xs(e, r)
        : ((o = gs(r, e, Ws, n)),
          !(a = qt.last(
            z(
    ...
    ec = function (e, t, n) {
      return e
        ? !Zs(t, n) &&
            ((r = t), !(!hu.isTextPosition(r) && _o.isBr(r.getNode()))) &&
            Qs(t) &&
            Js(n)
        : !Zs(n, t) && Js(t) && Qs(n);
      var r;
      ...
      return _o.isText(u)
        ...
        ? Da(u)
          ? A.some(
              e
                ? hu.before(u)
                : ((a = u), _o.isBr(a) ? hu.before(a) : hu.after(a))
            )
          : ((r = t),
            (o = u),
            (i = (n = e) ? hu.before(o) : hu.after(o)),
            tc(n, r, i))
        : A.none();
    },
    rc = d(tc, !0),
    ...
    sc = function (e, t, n) {
      return !(
        ...
        !zu(e, t) ||
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(ca)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        0)
      ...
      if (t) {
        if (((v = t), Yt.isArray(v.start)))
          return (
            (p = t),
            (h = (g = b).createRng()),
            cc(g, !0, p, h) && cc(g, !1, p, h) ? A.some(h) : A.none()
          );
        if ("string" == typeof t.start)
          return A.some(
            ((f = t),
            (d = (l = b).createRng()),
            (m = Su(l.getRoot(), f.start)),
            d.setStart(m.container(), m.offset()),
            (m = Su(l.getRoot(), f.end)),
      ...
      moveStart: function (e, t, n) {
        ...
        if (
          (n.startContainer !== n.endContainer ||
            !hc(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
            a < (i = u.childNodes).length
              ? (r = new ro((u = i[a]), e.getParent(u, e.isBlock)))
              : (r = new ro(
                  (u = i[i.length - 1]),
    ...
    Rc = function (t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = xc(i, o, "ul,ol").reverse()[0] || o), !o))
        for (
          o = n;
          o[r] && !i.isBlock(o[r]) && ((o = o[r]), !yc.isEq(o, "br"));
    ...
    _c = function (e, t, n, r, o, i, a) {
      ...
      if (
        ...
        (f = e.getRoot()),
        3 === u.nodeType && !wc(u) && (a ? 0 < r : i < u.nodeValue.length))
      )
        return u;
      for (;;) {
    ...
    Dc = function (e, t, n, r) {
      ...
      return (
        ...
        (i = Sc(c, i)),
        (u = Sc(c, u)),
        (Cc(i.parentNode) || Cc(i)) &&
          ((i = Cc(i) ? i : i.parentNode),
          3 ===
            (i = t.collapsed ? i.previousSibling || i : i.nextSibling || i)
              .nodeType && (a = t.collapsed ? i.length : 0)),
        (Cc(u.parentNode) || Cc(u)) &&
          ((u = Cc(u) ? u : u.parentNode),
          3 ===
        ...
        (n[0].block || n[0].selector) &&
          ((i = Rc(e, n, i, "previousSibling")),
          (u = Rc(e, n, u, "nextSibling")),
          n[0].block &&
    ...
    Pc =
      ...
      (Fs = tr.detect().browser),
      {
        get: function (e) {
          if (!Ls(e))
            throw new Error(
              "Can only get " + Is + " value of a " + Is + " node"
            );
          return zs(e).getOr("");
        },
        getOption: (zs =
        ...
        set: function (e, t) {
          if (!Ls(e))
            throw new Error(
              "Can only set raw " + Is + " value of a " + Is + " node"
            );
          e.dom().nodeValue = t;
        },
      }),
    ...
    Ic = function (r, o, i, a) {
      return Ir(o).fold(
        ...
        function (e) {
          return "br" === a || (lr((n = o)) && "\ufeff" === Lc(n))
            ? "valid"
            : cr((t = o)) && zi(t, Yi())
            ? "existing"
            : Fu(o)
            ? "caret"
            : yc.isValid(r, i, a) && yc.isValid(r, ur(e), i)
            ? "valid"
            : "invalid-child";
          var t, n;
        }
      ...
      var o,
        ...
        u =
          void 0 === a
            ? ((o = "mce-annotation"),
              (i = new Date().getTime()),
              o + "_" + Math.floor(1e9 * Math.random()) + ++na + String(i))
            : a,
        s = (function (e, t) {
          var n = {};
          for (var r in e)
  ...
  var Vc = function (e) {
    ...
    Hc = function (e) {
      return (
        ...
        ("\xa0" === (t = e.firstChild).data || _o.isBr(t))
      );
      var t;
    },
    jc = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Hc(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    Qc = function (e) {
      var t = Vi(e, "br"),
        n = z(
          (function (e) {
            for (var t = [], n = e.dom(); n; )
              t.push(rr.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          fo
        );
  ...
  var ol = function (a) {
    ...
    ul = function (e, t) {
      var n,
        ...
        a = o.startOffset;
      o.collapsed &&
        ((n = i), (r = a), _o.isText(n) && "\xa0" === n.nodeValue[r - 1]) &&
        _o.isText(i) &&
        (i.insertData(a - 1, " "),
        i.deleteData(a, 1),
        o.setStart(i, a),
    ...
    sl = function (e, t, n) {
      ...
      if (
        ...
        if (
          ((u = r.parse(t, T)), !0 === n.paste && Kc(e.schema, u) && Yc(p, i))
        )
          return (
            (l = Xc(o, p, e.selection.getRng(), u)),
      ...
      findRootInline: function (e, t, n) {
        var r,
          ...
          a =
            ...
            (o = t),
            (i = n),
            z(gi.DOM.getParents(i.container(), "*", o), r));
        return A.from(a[a.length - 1]);
      },
      isRtl: function (e) {
        return (
          "rtl" === gi.DOM.getStyle(e, "direction", !0) ||
          ((t = e.textContent), wl.test(t))
        );
        var t;
      },
      isAtZwsp: function (e) {
      ...
      return (
        (Da(t) &&
          !1 ===
            ((r = e),
            (o = t),
            _o.isText(o) && /^[ \t\r\n]*$/.test(o.data) && !1 === Al(r, o))) ||
        ((n = t),
        _o.isElement(n) && "A" === n.nodeName && n.hasAttribute("name")) ||
        _l(t)
      );
      var n, r, o;
    },
      ...
      return qa([t, n], Ll).filter(function (e) {
        return (
          ...
          Ir((n = e).from().block())
            ...
            .isSome() &&
          ((t = e),
          !1 === _o.isContentEditableFalse(t.from().block()) &&
            !1 === _o.isContentEditableFalse(t.to().block()))
        );
        var t, n, r;
      });
    },
    ...
    Yl = function (e, t, n) {
      return (
        Xl(!0, t), Xl(!1, n), Kl(t, n).fold(d(Wl, e, t, n), d($l, e, t, n))
      );
    },
    Gl = function (e, t, n, r) {
    ...
    ef = function (e) {
      ...
      return Zl(i, a)
        ...
        : ((n = i),
          ...
          qa(
            [
              Sl(n, rr.fromDom(o.startContainer)),
              Sl(n, rr.fromDom(o.endContainer)),
            ],
            function (e, t) {
              return (
                !1 === Or(e, t) &&
    ...
    uf = function (e, t) {
      return (
        ((n = t), A.from(n.getNode(!0)).map(rr.fromDom)).exists(fo) ||
        of(!1, e, t).isSome()
      );
      var n;
    },
    ...
    mf = function (r, e, o) {
      return (
        ...
        _o.isElement(a) && a.getAttribute("data-mce-caret") === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            t && _o.isContentEditableFalse(n.nextSibling)
              ? A.some(lf.moveToElement(n.nextSibling))
              : !1 === t && _o.isContentEditableFalse(n.previousSibling)
              ? A.some(lf.moveToElement(n.previousSibling))
    ...
    hf = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === hu.isTextPosition(n) &&
        o === r.parentNode &&
        i > hu.before(r).offset()
          ? hu(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    vf = function (e) {
      return Da(e.previousSibling)
        ? A.some(
            ((t = e.previousSibling),
            _o.isText(t) ? hu(t, t.data.length) : hu.after(t))
          )
        : e.previousSibling
        ? ic.lastPositionIn(e.previousSibling)
        : A.none();
      var t;
    },
    bf = function (e) {
      return Da(e.nextSibling)
        ? A.some(((t = e.nextSibling), _o.isText(t) ? hu(t, 0) : hu.before(t)))
        : e.nextSibling
        ? ic.firstPositionIn(e.nextSibling)
        : A.none();
      var t;
    },
    yf = function (r, o) {
      ...
      return (
        ...
        qa([n, r, t], function (e, t, n) {
          ...
          return (
            (o = s),
            (i = l),
            (a = Xn((r = u).data).length),
            r.appendData(o.data),
            Ri(rr.fromDom(o)),
            i && pf(r, a),
            n.container() === s ? hu(u, c) : n
          );
        }).orThunk(function () {
          return (
            l &&
    ...
    Rf = function (e, t) {
      ...
      return (
        !!_o.isContentEditableFalse(r) &&
        ((n = rr.fromDom(e.getBody())),
        F(Vi(n, ".mce-offscreen-selection"), Ri),
        Tf(e, t, rr.fromDom(e.selection.getNode())),
        kl(e),
        !0)
      );
    },
    ...
    Df = function (e) {
      var t,
        n = (function (e, t) {
          for (; t && t !== e; ) {
            if (_o.isContentEditableTrue(t) || _o.isContentEditableFalse(t))
              return t;
            t = t.parentNode;
          }
          return null;
      ...
      return (
        _o.isContentEditableTrue(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
          ((t = e.dom.create("br", { "data-mce-bogus": "1" })),
          e.dom.setHTML(n, ""),
          n.appendChild(t),
          e.selection.setRng(hu.before(t).toRange())),
        !0
      );
    },
    Bf = _o.isText,
    ...
    If = function (e, t) {
      return e
        ? (function (e) {
            if (Bf(e.previousSibling))
              return (
                Pf(e.previousSibling) || e.previousSibling.appendData(ca),
                e.previousSibling
              );
        ...
        : (function (e) {
            if (Bf(e.nextSibling))
              return (
                Of(e.nextSibling) || e.nextSibling.insertData(0, ca),
                e.nextSibling
              );
    ...
    nd = function (n, e, r, t, o, i) {
      return qa(
        [El.findRootInline(e, r, t), El.findRootInline(e, r, o)],
        function (e, t) {
          return e !== t && El.hasSameParentBlock(r, e, t)
            ? jf.after(n ? e : t)
            : i;
        }
      ).getOr(i);
    ...
    od = function (e, t) {
      return e
        ? t.fold(H(A.some, jf.start), A.none, H(A.some, jf.after), A.none)
        : t.fold(A.none, H(A.some, jf.before), A.none, H(A.some, jf.end));
    },
    id = function (a, u, s, c) {
    ...
    fd = function (e, t, n) {
      var r = e ? 1 : -1;
      return (
        t.setRng(hu(n.container(), n.offset() + r).toRange()),
            ...
            gd(a) &&
              ...
              (function (e, t) {
                if (
                  ...
                  hu.isTextPosition(n) &&
                    !1 === El.isAtZwsp(n) &&
                    (md(e, Yu.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(a, u),
              (function (n, r, o, e) {
    ...
    Cd = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          ad(s, u, hu.fromRangeStart(r.selection.getRng()))
            .map(cd)
            .map(yd(r, o));
      }),
        r.nodeChanged();
    ...
    xd = function (n, r, i, o) {
      ...
      return s
        .bind(function (e) {
          return i
            ? e.fold(j(A.some(cd(e))), A.none, j(A.some(sd(e))), A.none)
            : e.fold(A.none, j(A.some(sd(e))), A.none, j(A.some(cd(e))));
        })
        .map(yd(n, r))
        .getOrThunk(function () {
            ...
            ? El.findRootInline(u, a, o)
                .map(function (e) {
                  return (
                    (o = e),
                    !!qa(
                      [ic.firstPositionIn(o), ic.lastPositionIn(o)],
                      function (e, t) {
                        var n = El.normalizePosition(!0, e),
                          r = El.normalizePosition(!1, t);
                        return ic
    ...
    Ld = function (n) {
      return ((r = n),
      qa(
        [Pd(r.cells(), r.rng().start()), Pd(r.cells(), r.rng().end())],
        function (e, t) {
        ...
        .fold(
          ...
          function (e) {
            return (
              ...
              (r = s),
              (o = e),
              (i = hu.fromRangeStart(t.selection.getRng())),
              Ol(o) ? Jd(t, o) : Qd(t, r, n, o, i)
            );
            var t, n, r, o, i;
          }
        )
    ...
    tm = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === s.length
        ...
        : ((n = e),
          (r = u),
          (o = rr.fromDom(n.getBody())),
          (i = n.selection.getRng()),
          0 !== (a = $d(n)).length ? Wd(n, a) : Xd(n, o, i, r));
    },
    nm = function (e, t) {
    ...
    Dm = function (o) {
      return function (r, e) {
        return A.from(e)
          ...
          .filter(cr)
          .bind(function (e) {
            return _m(o, r, e.dom()).or(
              ((t = o), (n = e.dom()), A.from(gi.DOM.getStyle(n, t, !0)))
            );
            var t, n;
          })
          .getOr("");
    ...
    Um = function (e, t, n) {
      for (
        var r = new ro(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
        (t = r[n ? "prev" : "next"]());
    ...
    Vm = function (e, t, n, r, o) {
      ...
      if (
        ...
        r && _o.isBr(o) && t && e.isEmpty(u))
      )
        return A.some(du(o.parentNode, e.nodeIndex(o)));
      for (i = new ro(o, u); (s = i[r ? "prev" : "next"]()); ) {
        if (
          "false" === e.getContentEditableParent(s) ||
          ((l = f), pa((c = s)) && !1 === Mm(c, l, Fu))
        )
          return A.none();
        if (_o.isText(s) && 0 < s.nodeValue.length)
          return !1 === Fm(s, f, "A")
            ? A.some(du(s, r ? s.nodeValue.length : 0))
            : A.none();
    ...
    Hm = function (e, t, n, r) {
      ...
      if (
        ...
        (l = _o.isElement(o) && i === o.childNodes.length),
        ...
        return A.none();
      if (
        (_o.isElement(o) && i > o.childNodes.length - 1 && (c = !1),
        _o.isDocument(o) && ((o = g), (i = 0)),
        o === g)
      ) {
        ...
        if (o.hasChildNodes()) {
          if (
            ...
            (o = o.childNodes[i]),
            (i = _o.isText(o) && l ? o.data.length : 0),
    ...
    Wm = function (e, t) {
      ...
      "LI" !== d || m || (l = f),
        s &&
          ...
          ((function (e, t, n) {
            for (
              var r, o = new ro(t, n), i = e.getNonEmptyElements();
              (r = o.next());
    ...
    Xm = function (e, t) {
      ...
      var n = rr.fromTag("br");
      Ei(rr.fromDom(t), n),
        qm(e.dom, e.selection, n.dom()),
        $m(e.dom, e.selection, n.dom(), !1),
        e.undoManager.add();
    },
    Ym = function (e, t) {
      return (
    ...
    Zm = function (e, t) {
      var n,
        ...
        i =
          ((n = e),
          (r = d(El.isInlineTarget, n)),
          (o = hu.fromRangeStart(n.selection.getRng())),
          ad(r, n.getBody(), o).filter(Jm));
    ...
    sg = function (e) {
      return tg(
        rr.fromDom(e.startContainer),
        e.startOffset,
        rr.fromDom(e.endContainer),
        e.endOffset
      );
    },
    cg = function (e) {
    ...
    mg = function (e) {
      return (e.bookmark ? e.bookmark : A.none())
        .bind(d(fg, rr.fromDom(e.getBody())))
        .bind(dg);
    },
    gg = function (e) {
  ...
  function Eg(s) {
    ...
    e({
      ...
      FontName: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle("fontname", { value: Lm(r, o) }),
          r.nodeChanged();
      },
      FontSize: function (e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle("fontsize", { value: Lm(r, o) }),
          r.nodeChanged();
      },
  ...
  var Tg,
    ...
    Mg = function (e, t, n) {
      var r, o;
      zi(e, t) && !1 === n
        ? ((o = t), Pi((r = e)) ? r.dom().classList.remove(o) : Ii(r, o), Fi(r))
        : n && Mi(e, t);
    },
    Fg = function (e, t) {
      Mg(rr.fromDom(e.getBody()), "mce-content-readonly", t),
        t
          ...
          : ((e.readonly = !1),
            ...
            Ig(e, "StyleWithCSS", !1),
            Ig(e, "enableInlineTableEditing", !1),
            Ig(e, "enableObjectResizing", !1),
            e.focus(),
            e.nodeChanged());
    },
    zg = function (e) {
    ...
    Vg = function (e, t) {
      return "selectionchange" === t
        ...
        ? (e.eventRoot || (e.eventRoot = Ug.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody();
    },
    Hg = function (e, t, n) {
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(Vg(n, e), e, n.delegates[e]),
  ...
  function Gg(i) {
    var a = {},
      ...
      u = function (e) {
        ...
        for (n in (Wg(Kg(e, "+"), function (e) {
          e in Yg
            ...
            : ((r.charCode = e.charCodeAt(0)),
              (r.keyCode = Xg[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        Yg))
          r[n] ? t.push(n) : (r[n] = !1);
        return (
          (r.id = t.join(",")),
          r.access && ((r.alt = !0), de.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (de.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        );
      },
      s = function (e, t, n, r) {
        var o;
        return (
          ((o = Yt.map(Kg(e, ">"), u))[o.length - 1] = Yt.extend(
            o[o.length - 1],
            { func: n, scope: r || i }
          )),
  ...
  var Jg = function (e) {
    ...
    Qg = function (t) {
      ...
      A.from(n.activeElement).map(rr.fromDom)).filter(function (e) {
    ...
    Zg = function (t, e) {
      return ((n = e),
      n.collapsed
        ? A.from(Va(n.startContainer, n.startOffset)).map(rr.fromDom)
    ...
    rp = function (e) {
      return e.inline
        ? np(e)
        : (t = e).iframeElement && Jg(rr.fromDom(t.iframeElement));
      var t;
    },
    op = function (e) {
    ...
    mp = function (e, t, n) {
      var r,
        ...
        p = e.inline
          ? g
          : ((r = g), rr.fromDom(r.dom().ownerDocument.documentElement)),
        h =
          ((o = e.inline),
          (a = t),
          (u = n),
  ...
  var Rp = function (e) {
    ...
    Dp = function (a) {
      return new me(function (e) {
        ...
        for (
          o = t.length, n = new (ie.getOrDie("Uint8Array"))(o), r = 0;
          r < n.length;
          r++
        )
          n[r] = t.charCodeAt(r);
  ...
  var Hp = function (e, t) {
    ...
    qp = function (e, t) {
      if (_o.isText(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || Hp(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
    ...
    $p = function (e) {
      ...
      if (
        ...
        v &&
          ...
          p.isValidChild(l, f.toLowerCase()) && !jp(h, b, v)))
      ) {
        for (
          ...
          if (
            ((y = h),
            (C = v),
            _o.isText(C) || (_o.isElement(C) && !Hp(y, C) && !pc(C)))
          ) {
            if (qp(h, v)) {
        ...
        [
          ...
          _o.isText(a)
            ? 0 === u
              ? A.some(rr.fromDom(a))
              : A.none()
            : A.from(a.childNodes[u]).map(rr.fromDom)),
          ((t = e),
          (n = t.endContainer),
          (r = t.endOffset),
          _o.isText(n)
            ? r === n.data.length
              ? A.some(rr.fromDom(n))
              : A.none()
            : A.from(n.childNodes[r - 1]).map(rr.fromDom)),
        ],
        function (e, t) {
          var n = V(Kp(o), d(Or, e)),
            r = V(Xp(o), d(Or, t));
      ...
      do {
        ...
        if (a[n.nodeName] && !/^(TD|TH)$/.test(n.nodeName))
          return void (r
            ...
            ? t.setEndBefore(n)
            : t.setEndAfter(n));
        if (de.ie && de.ie < 11 && e.isBlock(n) && e.isEmpty(n))
      ...
      (t = gi.DOM),
        ...
        (r = function (e) {
          ...
          if (p.dragging) {
            var g =
              ((f = p),
              { pageX: (d = nh(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
            (c = p.ghost),
              (l = h.getBody()),
        ...
        (n = e).on("drop", function (e) {
          var t =
            "undefined" != typeof e.clientX
              ...
              : null;
          (rh(t) || rh(n.dom.getContentEditableParent(t))) &&
            e.preventDefault();
        });
    },
    fh = function (e) {
  ...
  var dh = function (o, i, a, e, u, t) {
      var n,
        ...
        r = function (e) {
          var t, n, r;
          for (
            r = fh([e]), -1 === o && (r = r.reverse()), t = 0;
            t < r.length;
            t++
          )
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, qt.last(l)) && c++, (n.line = c), u(n)))
                return !0;
              l.push(n);
            }
        };
    ...
    wh = function (e, o) {
      return qt.reduce(e, function (e, t) {
        var n, r;
        return (
          (n = Math.min(yh(e, o), Ch(e, o))),
          (r = Math.min(yh(t, o), Ch(t, o))),
          xh(o, t)
            ? t
            : xh(o, e)
            ? e
    ...
    zh = function (g) {
      var p,
        ...
        b = function (e, t) {
          return (
            (t = ws(e, a, t)),
            -1 === e ? hu.fromRangeStart(t) : hu.fromRangeEnd(t)
          );
        },
        n = function (e) {
                  ...
                  ? ((l = f = n.cloneNode(!0)),
                    (s = g.fire("ObjectSelected", {
                      ...
                      : ((r = Ki(rr.fromDom(g.getBody()), "#" + h).fold(
                        ...
                        o.addRange(e),
                        F(
                          Vi(rr.fromDom(g.getBody()), "*[data-mce-selected]"),
                          function (e) {
        ...
        l = function () {
          p &&
            ...
            Ki(rr.fromDom(g.getBody()), "#" + h).each(Ri),
            (p = null)),
            Ki(rr.fromDom(g.getBody()), "#" + h).each(Ri),
            (p = null);
        },
          ...
          ((function () {
            g.on("mouseup", function (e) {
              ...
              g.on("click", function (e) {
                var t;
                (t = Fh(g, e.target)) &&
                  (Lh(t) && (e.preventDefault(), g.focus()),
                  Ph(t) && g.dom.isChildOf(t, g.selection.getNode()) && l());
              }),
            ...
            (r = !1),
              ...
              g.on("mousedown", function (e) {
                ...
                if (
                  ...
                  !1 !== mp(g, e.clientX, e.clientY)
                )
                  if ((t = Fh(g, n)))
                    Lh(t)
                      ? (e.preventDefault(), c(Rh(g, t)))
                      : (l(),
                        (Ph(t) && e.shiftKey) ||
                          Sh(e.clientX, e.clientY, g.selection.getRng()) ||
                          (C(),
              ...
              g.on("keypress", function (e) {
                Oh.modifierPressed(e) ||
                  (e.keyCode, Lh(g.selection.getNode()) && e.preventDefault());
              }),
          ...
          )),
        {
          ...
          showBlockCaretContainer: function (e) {
            e.hasAttribute("data-mce-caret") &&
              (wa(e), u(s()), g.selection.scrollIntoView(e[0]));
          },
          hideFakeCaret: C,
          destroy: function () {
            o.destroy(), (p = null);
    ...
    return {
      parse: function (e) {
        ...
        for (
          ...
          if ((_ < t.index && H(O(e.substr(_, t.index - _))), (n = t[6])))
        ...
        for (_ < e.length && H(O(e.substr(_))), o = D.length - 1; 0 <= o; o--)
    ...
    return (
      ...
      (o = {
        ...
        add: function (e, t) {
          ...
          (e.bookmark = Iu.getUndoBookmark(u.selection)),
        ...
        undo: function () {
          ...
          return (
            ...
            0 < c &&
              ((e = l[--c]), iv(u, e, !0), d(!0), u.fire("undo", { level: e })),
            e
          );
        },
        redo: function () {
          ...
          return (
            c < l.length - 1 &&
              ((e = l[++c]), iv(u, e, !1), d(!0), u.fire("redo", { level: e })),
            e
          );
        },
        clear: function () {
        ...
        if ("undefined" == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              ...
              if (
                (!o || n.exact) &&
                !lv(u, yc.normalizeStyleValue(e, yc.replaceVars(c[a], i), a))
              )
                return;
            }
        } else
    ...
    hv = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!dv(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !dv(e, o, t, n)));
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function (e) {
              var t, n;
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && pv(r, e, n, i) && ((u[n] = !0), a.push(n));
            },
            r.dom.getRoot()
          ),
          a
      ...
      return (
        t === r && _o.isText(t)
          ? 0 < n &&
            ...
            ((t = (r = vv(t, n)).previousSibling),
            n < o
              ? ((t = r = vv(r, (o -= n)).previousSibling),
          ...
          : (_o.isText(t) &&
            ...
            _o.isText(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = vv(r, o).previousSibling).nodeValue.length)),
    ...
    Ev = function (e, t, n) {
      ...
      if (xv(t)) Tf(e, !1, rr.fromDom(t), n);
        ...
        var a = i.getRng(),
          ...
          s =
            ((r = wv(t)) && r.nodeValue.charAt(0) === yv && r.deleteData(0, 1),
            r);
        a.startContainer === s &&
          0 < a.startOffset &&
    ...
    Rv = function (i) {
      i.on("mouseup keydown", function (e) {
        ...
        (t = i),
          ...
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== yv ||
            Sv(t, zu(o, r.getStart())),
          (37 !== n && 39 !== n) || Sv(t, zu(o, r.getStart()));
      });
    },
    _v = function (e, t) {
      return (
        e.schema.getTextInlineElements().hasOwnProperty(ur(t)) &&
        !Fu(t.dom()) &&
        !_o.isBogus(t.dom())
      );
    },
      ...
      r.collapsed ||
        ...
        Ov(
          Bv(Bv(n, t), function (e) {
            return (
              t(e.previousSibling) && -1 !== qt.indexOf(n, e.previousSibling)
            );
          }),
          function (e) {
            var t, n;
  ...
  var Pv = function (e, t) {
    ...
    zv = function (e, t, n) {
      ...
      return (
        ...
        _o.isText(r) &&
          n &&
          o >= r.nodeValue.length &&
          (r = new ro(r, e.getBody()).next() || r),
        _o.isText(r) &&
          !n &&
          0 === o &&
          (r = new ro(r, e.getBody()).prev() || r),
        r
      );
    },
    Uv = function (e, t, n, r) {
    ...
    Hv = function (e, t, n, r) {
      return (
        !(t = yc.getNonWhiteSpaceSibling(t, n, r)) ||
        "BR" === t.nodeName ||
        e.isBlock(t)
      );
    },
    jv = function (e, n, r, o, i) {
      ...
      if (
        ...
        !(
          Mv((l = o), (f = n).inline) ||
          Mv(l, f.block) ||
          (f.selector ? _o.isElement(l) && c.is(l, f.selector) : void 0) ||
      ...
      if ("all" !== n.remove)
        for (
          Iv(n.styles, function (e, t) {
            (e = yc.normalizeStyleValue(y, yc.replaceVars(e, r), t)),
              "number" == typeof t && ((t = e), (i = 0)),
              (n.remove_similar || !i || Mv(yc.getStyle(y, i, t), e)) &&
                y.setStyle(o, t, ""),
              (u = 1);
          }),
            u &&
            ...
            Iv(n.attributes, function (e, t) {
              var n;
              if (
                ((e = yc.replaceVars(e, r)),
                "number" == typeof t && ((t = e), (i = 0)),
                !i || Mv(y.getAttrib(i, t), e))
              ) {
                if (
                  "class" === t &&
                  (e = y.getAttrib(o, t)) &&
                ...
                "class" === t && o.removeAttribute("className"),
                  Lv.test(t) && o.removeAttribute("data-mce-" + t),
                  o.removeAttribute(t);
              }
            }),
          ...
          g.block &&
            (b
              ? h === v.getRoot() &&
                ((g.list_block && Mv(m, g.list_block)) ||
                  Iv(Yt.grep(m.childNodes), function (e) {
                    yc.isValid(d, b, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = Uv(v, e, b)),
              ...
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                (Hv(v, m, !1) ||
                  Hv(v, m.firstChild, !0, 1) ||
                  m.insertBefore(v.create("br"), m.firstChild),
                Hv(v, m, !0) ||
                  Hv(v, m.lastChild, !1, 1) ||
    ...
    $v = function (s, c, l, e, f) {
      ...
      if (e)
        ...
        !u.select("td[data-mce-selected],th[data-mce-selected]").length
          ...
          : ((t = Iu.getPersistentBookmark(s.selection, !0)),
            o(r.getRng()),
            r.moveToBookmark(t),
            m.inline &&
              hv.match(s, c, l, r.getStart()) &&
              yc.moveStart(u, r, r.getRng()),
            s.nodeChanged());
      else {
        e = r.getNode();
        for (
    ...
    eb = function (e, t) {
      ...
      1 === t.nodeType &&
        ...
        ((n = yc.getTextDecoration(e, t.parentNode)),
    ...
    nb = function (e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) &&
        (Yt.walk(r, d(eb, e), "childNodes"), eb(e, r));
    },
    rb = function (e, t, n, r) {
      t.styles &&
        ...
        Gv(
          r,
          Jv(e, "fontSize"),
          Qv(e, "backgroundColor", yc.replaceVars(t.styles.backgroundColor, n))
        );
    },
    ob = function (e, t, n, r) {
      ("sub" !== t.inline && "sup" !== t.inline) ||
        (Gv(r, Jv(e, "fontSize"), Qv(e, "fontSize", "")),
        e.remove(e.select("sup" === t.inline ? "sub" : "sup", r), !0));
    },
    ib = function (e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = Yv(e, yc.getNonWhiteSpaceSibling(r), r)),
        (r = Yv(e, r, yc.getNonWhiteSpaceSibling(r, !0))));
    },
          ...
          if (r)
            ...
            !(function (e, t, n) {
              ...
              (a = (r = c.getRng(!0)).startOffset),
                ...
                (o = zu(e.getBody(), c.getStart())) && (i = wv(o));
              var l,
                f,
                d = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              s &&
    ...
    pb = function (e, t) {
      var n,
        ...
        g = function (e) {
          ...
          return (
            ...
            (t = gb.create(o.name)),
            (n = t),
            (r = o).classes.length && gb.addClass(n, r.classes.join(" ")),
            gb.setAttribs(n, r.attrs),
            t
          );
        },
        p = function (n, e, t) {
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = g(o)),
          (r = gb.create("div")).appendChild(p(n, e.slice(1), o.siblings)),
          r)
        : "";
    },
    hb = function (e) {
    ...
    bb = function (n, e) {
      ...
      return "preview" in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || "span"),
          (i = vb(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), (r = pb(i, n)))
            : (r = pb([t], n)),
            ...
            if (
              !(
                ("background-color" === e &&
                  ...
                  ((t = gb.getStyle(n.getBody(), e, !0)),
                  "#ffffff" === gb.toHex(t).toLowerCase())) ||
    ...
    yb = function (e, t, n, r, o) {
      var i = t.get(n);
      !hv.match(e, n, r, o) || ("toggle" in i[0] && !i[0].toggle)
        ? cb.applyFormat(e, n, r, o)
        : $v(e, n, r, o);
    },
    Cb = function (e) {
  ...
  var wb,
        ...
        t.addAttributeFilter("data-mce-tabindex", function (e, t) {
          ...
          t.addNodeFilter("noscript", function (e) {
            for (var t, n = e.length; n--; )
              (t = e[n].firstChild) && (t.value = qo.decode(t.value));
          }),
    ...
    Ab = function (e, t) {
      ...
      t.convert_fonts_to_spans &&
        Tb(e, r, Yt.explode(t.font_size_legacy_values)),
        (n = r),
    ...
    Ob = (function () {
      ...
      return (
        ...
        (a.prototype.getAll = function (e) {
          var t,
            n = [];
          for (t = this.firstChild; t; t = Bb(t, this))
            t.name === e && n.push(t);
          return n;
        }),
    ...
    Pb = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Ob("br", 1)).shortEnded = !0)
        : (r.empty().append(new Ob("#text", 3)).value = "\xa0");
    },
    Lb = function (e) {
            ...
            if (
              ...
              o &&
                ...
                Mb(h, m, g, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && Pb(p, n, d, i)));
            } else {
              for (
                a = o;
                i &&
              ...
              a === i &&
                ...
                (((l = new Ob("#text", 3)).value = "\xa0"), o.replace(l));
            }
        }),
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          (a = a || {}),
            ...
            (D = {}),
            (l = jb(
              Ub("script,style,head,html,body,title,meta,param"),
              T.getBlockElements()
            ));
          ...
          t = Hh(
            {
              ...
              text: function (e, t) {
                ...
                f ||
                  ((e = e.replace(x, " ")),
                  Fb(d.lastChild, l) && (e = e.replace(y, ""))),
                  0 !== e.length &&
              ...
              start: function (e, t, n) {
                ...
                if ((n = h ? T.getElementRule(e) : {})) {
                  ...
                  n.paddEmpty && (Lb(d) || Mb(T, g, b, d)) && Pb(k, a, l, d),
                    (d = d.parent);
                }
              },
            },
            ...
            h &&
              ...
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = Ub("tr,td,th,tbody,thead,tfoot,table"),
  ...
  var $b = function (e, t, n) {
    ...
    Xb = function (e, t, n, r, o) {
      ...
      return (
        (a = e),
        (s = c),
        !(u = o).no_events && a ? Dg(a, Eb(u, { content: s })).content : s
      );
    };
  function Yb(e, t) {
    var a,
  ...
  var Jb,
        ...
        O = function (e) {
          ...
          (t = e.screenX - d),
            ...
            (_(u) && !1 !== a.settings.resize_img_proportional
              ? !Oh.modifierPressed(e)
              : Oh.modifierPressed(e) || (_(u) && f[2] * f[3] != 0)) &&
              (T(t) > T(n)
                ? ((C = A(y * b)), (y = A(C / b)))
                : ((y = A(C / b)), (C = A(y * b)))),
    ...
    oy = function (e, t, n) {
      ...
      if (
        ...
        !u.isDefaultPrevented() && _o.isElement(t))
      ) {
      ...
      return py(l, e).bind(function (c) {
        return py(l, t).map(function (e) {
          return (
            ...
            (a = r.x()),
            (u = r.y()),
            (s = i < u ? hy(t, o, i, a, u) : hy(t, o, u, a, i)),
            ly(t.element(), gy(s), s)
          );
          var t, n, r, o, i, a, u, s;
        });
    ...
    Sy = function (e, t) {
      ...
      return 0 < o.length
        ? Ey(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? wy() : Ny(n, r[0]));
    },
    ky = function (e, t) {
      if (
        (void 0 === t && (t = {}),
    ...
    Dy = function (e, t) {
      for (var n = e; e && _o.isText(e) && 0 === e.length; )
    ...
    Py = function (e) {
      return (
        !(!e || !e.ownerDocument) &&
        Pr(rr.fromDom(e.ownerDocument), rr.fromDom(e))
      );
    },
    Ly = function (u, s, e, c) {
      var n,
        ...
        i = function (e, t) {
          ...
          if (
            (o = e) &&
            (Oy(o) || (Py(o.startContainer) && Py(o.endContainer)))
          ) {
            var o,
              i = Oy(e) ? e : null;
            if (i) {
        ...
        p = {
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? Dy(r.nextSibling, !0) : r.parentNode),
                    (o = 0 === a ? Dy(o.previousSibling, !1) : o.parentNode),
                    r && r === o))
                    ? r
                    : n && 3 === n.nodeType
                    ? n.parentNode
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              ...
              if (
                ((i = e.getRoot()),
                (n = e.getParent(n || Ry(i, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || _y(i, t, t.collapsed), e.isBlock)),
                n && n !== i && a.push(n),
                n && r && n !== r)
              )
                for (var u = new ro((o = n), i); (o = u.next()) && o !== r; )
          ...
          getBoundingClientRect: function () {
            var e = m();
            return e.collapsed
              ? hu.fromRangeStart(e).getClientRects()[0]
        ...
        : ((u = ma(r.startContainer)),
          f((i = ks(e, t.getBody(), r)))
            ...
            ? f(i)
              ...
              : f((a = n(i))) &&
                ((!(c = hs((s = i), a)) && _o.isBr(s.getNode())) || c)
    ...
    Hy = function (e, t, n, r) {
      ...
      if (
        ((d = My(r)),
        (o = ks(e, t.getBody(), r)),
        (i = n(t.getBody(), ph(1), o)),
        (a = z(i, hh(1))),
        (s = qt.last(o.getClientRects())),
        (zy(o) || Rs(o)) && (d = o.getNode()),
        (Fy(o) || _s(o)) && (d = o.getNode(!0)),
        !s)
      )
        return null;
      if (((c = s.left), (u = wh(a, c)) && Iy(u.node)))
        return (
          (l = Math.abs(c - u.left)),
      ...
      if (d) {
        var m = (function (e, t, n, r) {
          ...
          1 === e
            ? ((o = l.next), (i = za), (a = Fa), (u = hu.after(r)))
            : ((o = l.prev), (i = Fa), (a = za), (u = hu.before(r))),
            (c = m(u));
          do {
            if (u.isVisible() && !a((s = m(u)), c)) {
              if (
                (0 < f.length && i(s, qt.last(f)) && d++,
                ((s = La(s)).position = u),
                (s.line = d),
                n(s))
              )
      ...
      return function () {
        var e,
          ...
          a =
            ...
            (n = Hy(r, e, o, i)) ? n : (n = jy(e, r, i)) || null);
  ...
  var Wy = function (e, t) {
    ...
    Ky = function (e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = Gs(n), f = r, d = [];
        f &&
        ((s = l), (c = f), (o = t === gu.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (_o.isBr(o.getNode(!1)))
          return t === gu.Forwards
            ...
            : { positions: Wy(t, d), breakType: Jb.Br, breakAt: A.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ((i = t),
              (a = f),
              (u = o),
              _o.isBr(u.getNode(i === gu.Forwards))
                ? Jb.Br
                : !1 === hs(a, u)
                ? Jb.Block
                : Jb.Wrap);
    ...
    uC = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === Jb.Wrap && 0 === a.positions.length) ||
        (!_o.isBr(n.getNode()) &&
          (i = u).breakType === Jb.Br &&
                ...
                return (
                  ...
                  void ((i = mm((r = u)))
                    ? r.undoManager.transact(function () {
                        ...
                        vr(e, gm(r)),
                          ki(e, rr.fromTag("br")),
                          n ? Ei(rr.fromDom(o), e) : Ni(rr.fromDom(o), e);
    ...
    yC = function (e, t, n, r) {
      return "" === t
        ? ((l = e), (f = r), (d = rr.fromTag("br")), bC(l, d, f), vC(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    CC = function (e, t, n) {
      return t
        ? ((o = e.dom()), Qy(o, n).breakAt.isNone())
        : ((r = e.dom()), Jy(r, n).breakAt.isNone());
      var r, o;
    },
    xC = function (t, n) {
      var e,
      ...
      (r = i),
      (o = d(Or, r)),
      $i(rr.fromDom(e.container()), co, o).filter(hC)).exists(function () {
        if (CC(i, n, a)) {
          var e = yC(i, u, s, n);
    ...
    VC = function (e, t, n) {
      for (var r = e[n ? "firstChild" : "lastChild"]; r && !_o.isElement(r); )
    ...
    HC = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        if (VC(n, r, !0) && VC(n, r, !1))
          FC(n, "LI") ? i.insertAfter(l, UC(n)) : i.replace(l, n);
        else if (VC(n, r, !0))
          FC(n, "LI")
            ? (i.insertAfter(l, UC(n)),
    ...
    WC = function (e, t, n) {
      return !1 === _o.isText(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === ca
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === ca
        ? t.data.length
        : n;
    },
    KC = function (e, t) {
    ...
    YC = function (a, e) {
      var t,
        ...
        k = function (e) {
          ...
          if (
            ((o = WC(e, s, i)),
            _o.isText(s) && (e ? 0 < o : o < s.nodeValue.length))
          )
            return !1;
      ...
      jm(x, E).each(function (e) {
        ...
        _o.isElement(s) &&
          ...
          (i = g && _o.isText(s) ? s.nodeValue.length : 0)),
        (u = KC(x, s)) &&
          (((m && !n) || (!m && n)) &&
            ...
            : (m && c === a.getBody()) ||
              ...
              ma(c)
                ...
                : ((t = ((y = E),
                  ...
                  C.setStart(
                    y.startContainer,
                    WC(!0, y.startContainer, y.startOffset)
                  ),
                  C.setEnd(y.endContainer, WC(!1, y.endContainer, y.endOffset)),
    ...
    xx = function (e, t) {
      return yx(t)
        ? Os(t)
        : Os(t) || ic.prevPosition(Cx(e, t).dom(), t).exists(Os);
    },
    wx = function (e, t) {
      return yx(t)
        ? Bs(t)
        : Bs(t) || ic.nextPosition(Cx(e, t).dom(), t).exists(Bs);
    },
    Nx = function (e) {
      return Ps(e)
        .bind(function (e) {
        ...
        .exists(function (e) {
          return (
            (t = wr(e, "white-space")), M(["pre", "pre-line", "pre-wrap"], t)
          );
          var t;
        });
    },
    Ex = function (e, t) {
      return (
        (o = e),
        (i = t),
        ic.prevPosition(o.dom(), i).isNone() ||
          ((n = e), (r = t), ic.nextPosition(n.dom(), r).isNone()) ||
          vx(e, t) ||
          bx(e, t) ||
          uf(e, t) ||
          af(e, t)
    ...
    Tx = function (e, t, n) {
      var r,
        ...
        i = du(t, 0);
      return Sx(n, 0) &&
        ((r = e), Nx((o = i)) || !(vx(r, o) || uf(r, o) || xx(r, o)))
        ? " " + n.slice(1)
        : n;
    },
    Ax = function (e, t, n) {
      var r,
        o,
        i = du(t, n.length);
      return Sx(n, n.length - 1) &&
        ((r = e), Nx((o = i)) || !(bx(r, o) || af(r, o) || wx(r, o)))
        ? n.slice(0, -1) + " "
        : n;
    },
    Rx = function (i, e) {
      return A.some(e)
        ...
        .bind(function (e) {
          ...
          return r !== o
            ? ((e.container().nodeValue = o), A.some(e))
            : A.none();
        });
    },
    _x = function (t) {
    ...
    Dx = function (r, o) {
      return function (e) {
        return (
          (t = r),
          !Nx((n = e)) && (Ex(t, n) || xx(t, n) || wx(t, n)) ? gx(o) : px(o)
        );
        var t, n;
      };
    },
    ...
    Ox = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          SC([{ keyCode: Oh.SPACEBAR, action: EC(Bx, t) }], n).each(function (
            e
          ) {
            n.preventDefault();
          }));
    ...
    Lx = function (e, t) {
      var n,
        r =
          ((n = e),
          Ki(rr.fromDom(n.getBody()), "*[data-mce-caret]").fold(
            j(null),
            function (e) {
              return e.dom();
            }
      ...
      if (r)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void Px(e, r))
          : void (ha(r) && (Px(e, r), e.undoManager.add()));
    },
    Ix = function (e) {
  ...
  var Vx = function (e) {
    ...
    Wx = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        f.content_editable &&
          (t.on("remove", function () {
            var e = this.getBody();
            qx.removeClass(e, "mce-content-body"),
              qx.removeClass(e, "mce-edit-focus"),
              qx.setAttrib(e, "contentEditable", null);
          }),
        ...
        t.readonly ||
          (t.inline &&
            "static" === qx.getStyle(n, "position", !0) &&
          ...
          o.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
            for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
              (t = e[n]).isEmpty(r) &&
                ...
                (t.append(new Ob("br", 1)).shortEnded = !0);
          }),
          o)),
        (t.serializer = Yb(f, t)),
        ...
        f.browser_spellcheck ||
          f.gecko_spellcheck ||
          ((m.body.spellcheck = !1), qx.setAttrib(n, "spellcheck", "false")),
        (t.quirks = Ux(t)),
        t.fire("PostRender"),
        ...
        0 < t.contentStyles.length &&
          ...
          t.dom.addStyle(r)),
        ((i = t),
        i.inline ? qx.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
          t.contentCSS,
          function (e) {
            $x(t);
          },
    ...
    Yx = function (e, t) {
      var n = Xx(e, t);
      t.editorContainer &&
        ((Kx.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = Kx.isHidden(t.editorContainer))),
        (e.getElement().style.display = "none"),
        Kx.setAttrib(e.id, "aria-hidden", "true"),
        n || Wx(e);
    },
    Gx = gi.DOM,
    Jx = function (t, n, e) {
      var r,
        ...
        i = Sp.get(e);
      if (
        ((r = Sp.urls[e] || t.documentBaseUrl.replace(/\/$/, "")),
        (e = Yt.trim(e)),
        i && -1 === Yt.inArray(n, e))
      ) {
        if (
    ...
    ew = function (e) {
      ...
      return e.inline
        ? Zx(null)
        : ((t = r), (n = Gx.create("div")), Gx.insertAfter(n, t), Zx(n));
    },
    tw = function (e) {
      var t,
        n,
    ...
    nw = function (t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label ||
          Gx.getAttrib(s, "aria-label", t.getLang("aria.rich_text_area"))),
        t.fire("ScriptsLoaded"),
        (o = (n = t).settings.theme),
        R(o)
          ? ((n.settings.theme = Qx(o)),
            (r = kp.get(o)),
            (n.theme = new r(n, kp.urls[o])),
            n.theme.init &&
              n.theme.init(
                n,
                kp.urls[o] || n.documentBaseUrl.replace(/\/$/, ""),
                n.$
              ))
          : (n.theme = {}),
        (i = t),
      ...
      !(function (e, t, n, r) {
        ...
        if (R(i)) {
          if (!ow(i) && !kp.urls.hasOwnProperty(i)) {
            var a = o.theme_url;
            a
              ? kp.load(i, t.documentBaseURI.toAbsolute(a))
              : kp.load(i, "themes/" + i + "/theme" + n + ".js");
          }
        ...
        if (t.getElement() && de.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (rw.insertAfter(
                rw.create("input", { type: "hidden", name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
      ...
      if (
        ...
        0 !== r.indexOf("/") ||
          ...
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri
              ? e.base_uri.path
              : new dw(document.location.href).directory),
            "" == e.base_uri.protocol
  ...
  (dw.prototype = {
    ...
    toRelative: function (e) {
      ...
      if ("./" === e) return e;
      if (
        ("mce_host" !== (e = new dw(e, { base_uri: this })).host &&
          this.host !== e.host &&
          e.host) ||
        this.port !== e.port ||
    ...
    toAbsolute: function (e, t) {
      return (e = new dw(e, { base_uri: this })).getURI(
  ...
  var mw = function (e, t, n) {
      ...
      if (
        ...
        r = Yt.trim(qh.trimExternal(e.serializer, n.innerHTML));
        ...
        A.from(u.getBody()).fold(j(s), function (e) {
          return hw(s)
            ? (function (e, t, n, r) {
                ...
                return (
                  (r.content = yo(rr.fromDom(t)) ? o : Yt.trim(o)),
                  vw(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  t.fire("SetContent", o))
                : ("raw" !== o.format &&
                    (r = rl({ validate: t.validate }, t.schema).serialize(
    ...
    xw = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          !e.inline &&
            r &&
            ((i = e), yw.setStyle(i.id, "display", i.orgDisplay)),
          Bg(e),
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              yw.unbind(r, "submit reset", n.formEventDelegate)),
    ...
    Aw = function (e, t, n) {
      ...
      (r = l),
        ...
        (l.menuItems = {}),
        t.cache_suffix &&
          (de.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")),
  ...
  Ew(
    (Aw.prototype = {
      ...
      show: function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Nw.show(this.getContainer()), Nw.hide(this.id)),
          this.load(),
          this.fire("show"));
      },
      hide: function () {
      ...
      getContent: function (e) {
        return (
          ...
          A.from(t.getBody()).fold(
            j("tree" === n.format ? new Ob("body", 11) : ""),
            function (e) {
              return mw(t, n, e);
            }
          )
      ...
      getElement: function () {
        return (
          this.targetElm || (this.targetElm = Nw.get(this.id)), this.targetElm
        );
      },
      getWin: function () {
        var e;
  ...
  var Rw,
    ...
    zw = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (Lw.unbind(document, "focusin", Rw), (Rw = null));
    },
    Uw = function (e) {
    ...
    Zw = function (e) {
      e !== Yw &&
        (e
          ? pn(window).on("resize scroll", Qw)
          : pn(window).off("resize scroll", Qw),
        (Yw = e));
    },
    eN = function (t) {
      var e = Jw;
      ...
      return (
        ...
        Dw.activeEditor === t &&
          (Dw.activeEditor = 0 < Jw.length ? Jw[0] : null),
  ...
  Kw(
    (Dw = {
      ...
      setup: function () {
        ...
        (this.baseURL = new dw(t).toAbsolute(e)),
          (this.documentBaseURL = t),
          (this.baseURI = new dw(this.baseURL)),
          (this.suffix = o),
          Uw(this);
      },
      overrideDefaults: function (e) {
        var t, n;
        (t = e.base_url) &&
          ((this.baseURL = new dw(this.documentBaseURL).toAbsolute(
            t.replace(/\/+$/, "")
          )),
          (this.baseURI = new dw(this.baseURL))),
          (n = e.suffix),
              ...
              r.types
                ? Ww(r.types, function (t) {
                    Yt.each(o, function (e) {
                      return (
                        !qw.is(e, t.selector) || (n(c(e), Kw({}, r, t), e), !1)
                      );
                    });
                  })
                : (Yt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          Gw[e.id] === e ||
            (null === t.get(e.id) &&
              ("length" !== e.id && (Gw[e.id] = e), Gw.push(e), Jw.push(e)),
            Zw(!0),
            (t.activeEditor = e),
            ...
            return (
              ...
              B(r.get(n.id))
                ...
                : (eN(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === Jw.length && qw.unbind(window, "beforeunload", _w),
                  n.remove(),
                  Zw(0 < Jw.length),
                  n)
            );
  ...
  ((tN = rN || (rN = {})).compareRanges = Im),
    (tN.getCaretRangeFromPoint = uy),
    (tN.getSelectedNode = Ua),
    (tN.getNode = Va);
  var oN,
    iN,
    aN = rN,
    ...
    dN = {
      ...
      intersect: function (e, t) {
        ...
        return (
          (n = sN(e.x, t.x)),
          (r = sN(e.y, t.y)),
          (o = uN(e.x + e.w, t.x + t.w)),
          (i = uN(e.y + e.h, t.y + t.h)),
          o - n < 0 || i - r < 0 ? null : fN(n, r, o - n, i - r)
        );
      },
