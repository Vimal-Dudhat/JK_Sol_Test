!(function () {
  ...
  function n(e, n, r, i, o, s, a, l, u, c, p, f) {
    ...
    return (
      ...
      !("number" != typeof f || !isFinite(f)) &&
        (e && 0 === parseFloat(f.toFixed(e)) && (f = 0),
        0 > f && ((d = !0), (f = Math.abs(f))),
        e && ((s = Math.pow(10, e)), (f = (Math.round(f * s) / s).toFixed(e))),
        -1 !== (f = f.toString()).indexOf(".") &&
          ((f = (e = f.split("."))[0]), r && (p = r + e[1])),
        n && (f = t((f = t(f).match(/.{1,3}/g)).join(t(n)))),
        d && l && (h += l),
        i && (h += i),
        d && u && (h += u),
        (h = h + f + p),
  ...
  function r(t, e, n, r, i, o, s, a, l, u, c, p) {
    ...
    return (
      ...
      !(!p || "string" != typeof p) &&
        (a &&
          p.substring(0, a.length) === a &&
          ((p = p.replace(a, "")), (f = !0)),
        r && p.substring(0, r.length) === r && (p = p.replace(r, "")),
        l &&
          p.substring(0, l.length) === l &&
          ((p = p.replace(l, "")), (f = !0)),
        i && p.slice(-1 * i.length) === i && (p = p.slice(0, -1 * i.length)),
        e && (p = p.split(e).join("")),
        n && (p = p.replace(n, ".")),
        f && (t += "-"),
        (t = Number((t + p).replace(/[^0-9\.\-.]/g, ""))),
        s && (t = s(t)),
        !("number" != typeof t || !isFinite(t)) && t)
    );
  }
          ...
          (r = o[n]),
            ...
            void 0 === i
              ...
              : "encoder" === r ||
                ...
                "edit" === r ||
                "undo" === r
              ? "function" == typeof i && (s[r] = i)
              : "string" == typeof i && (s[r] = i);
        return (
          e(s, "mark", "thousand"),
          e(s, "prefix", "negative"),
          e(s, "prefix", "negativeBefore"),
          s
        );
      })(s)),
      (this.to = function (t) {
  ...
  (function (t) {
    ...
    function p(t, e, n) {
      ...
      return (
        ...
        o +
          ((p = n),
          u((a = [r, i]), a[0] < 0 ? p + Math.abs(a[0]) : p - a[0]) / l(o, s))
      );
    }
    ...
    function f(t, e, n, r) {
      ...
      return n
        ? r - (i = t[l - 1]) > ((o = t[l]) - i) / 2
          ...
          : i
        : e[l - 1]
        ? t[l - 1] + ((s = r - t[l - 1]), (a = e[l - 1]), Math.round(s / a) * a)
        : r;
    }
    ...
    function d(t, n, r) {
      ...
      if (
        !e((i = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t))) ||
        !e(n[0])
      )
    ...
    function h(t, e, n) {
      if (!e) return !0;
      n.xSteps[t] =
        u([n.xVal[t], n.xVal[t + 1]], e) / l(n.xPct[t], n.xPct[t + 1]);
    ...
    function w(t, e) {
      if (((e = r(e)), !Array.isArray(e) || !e.length))
    ...
    function U(t, n) {
      ...
      if (((t.limit = t.spectrum.getMargin(n)), !t.limit || t.handles < 2))
        throw new Error(
    ...
    function M(t, n) {
      ...
      if (0 !== n) {
        if (((t.padding = t.spectrum.getMargin(n)), !t.padding))
          throw new Error(
    ...
    function O(t, e) {
      if (!1 !== e)
        if (!0 === e) {
          ...
          if (((t.tooltips = r(e)), t.tooltips.length !== t.handles))
            throw new Error(
    ...
    function z(e, i, l) {
      ...
      function U(t, e, n) {
        ...
        return (
          ...
          Object.keys(t).forEach(function (r) {
            var o, a;
            (o = r),
              ((a = t[r])[1] = a[1] && e ? e(a[0], a[1]) : a[1]),
              (s += "<div " + p(o, i.cssClasses.marker, a) + "></div>"),
              a[1] &&
                (s +=
                  "<div " +
                  p(o, i.cssClasses.value, a) +
                  ">" +
                  n.to(a[0]) +
                  "</div>");
          }),
          ...
          m =
            ...
            r.forEach(function (t, i) {
              var s,
                ...
                w = r[i + 1];
              if (
                ("steps" === n && (s = x.xNumSteps[i]),
                s || (s = w - b),
                !1 !== b && void 0 !== w)
              )
                for (
                  s = Math.max(s, 1e-7), a = b;
                  a <= w;
                  a = (a + s).toFixed(7) / 1
                ) {
                  for (
                    m = (d = (f = x.toStepping(a)) - c) / e,
                      v = d / (g = Math.round(m)),
                      p = 1;
                    p <= g;
                    p += 1
                  )
                    o[(c + p * v).toFixed(5)] = ["x", 0];
                  (h = r.indexOf(a) > -1 ? 1 : "steps" === n ? 2 : 0),
                    !i && l && (h = 0),
                    (a === w && u) || (o[f.toFixed(5)] = [a, h]),
                    (c = f);
                }
            }),
            o),
            ...
            return (
              ...
              (o.classList
                ...
                !!(e = (function (t, e) {
                  ...
                  (e = e || a()),
                    (o || s) && ((n = t.clientX + e.x), (r = t.clientY + e.y));
                  return (
                    (t.pageOffset = e),
                    (t.points = [n, r]),
                    (t.cursor = o || s),
                ...
                !(t === g.start && void 0 !== e.buttons && e.buttons > 1) &&
                (!r.hover || !e.buttons) &&
                ((e.calcPoint = e.points[i.ort]), void n(e, r)))
            );
            var o, s;
          },
          s = [];
            ...
            (100 *
              (t -
                ...
                /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) &&
                  (s.x = 0),
                n ? r.top + s.y - o.clientTop : r.left + s.x - o.clientLeft))) /
            P();
      ...
      function H(t, e) {
        ...
        if (
          ((document.documentElement.noUiListeners = r.concat(s, a)), t.cursor)
        ) {
          (document.body.style.cursor = getComputedStyle(t.target).cursor),
            c.length > 1 && o(v, i.cssClasses.drag);
          var l = function () {
            return !1;
          };
          (document.body.noUiListener = l),
            document.body.addEventListener("selectstart", l, !1);
        }
        e.handleNumbers.forEach(function (t) {
          A("start", t);
        });
      ...
      function D(t) {
        ...
        var e,
          ...
          a =
            ...
            o);
        if (!1 === a) return !1;
        i.events.snap || n(v, i.cssClasses.tap, i.animationDuration),
          X(a, s, !0, !0),
          B(),
          A("slide", a, !0),
          A("set", a, !0),
      ...
      function q(t, e, n, r, o) {
        ...
        return (
          c.length > 1 &&
            (r && e > 0 && (n = Math.max(n, t[e - 1] + i.margin)),
            o && e < c.length - 1 && (n = Math.min(n, t[e + 1] - i.margin))),
          c.length > 1 &&
            i.limit &&
            (r && e > 0 && (n = Math.min(n, t[e - 1] + i.limit)),
            o && e < c.length - 1 && (n = Math.max(n, t[e + 1] - i.limit))),
          i.padding &&
            (0 === e && (n = Math.max(n, i.padding)),
            e === c.length - 1 && (n = Math.min(n, 100 - i.padding))),
          (n = x.getStep(n)),
          (s = n),
          (n = Math.max(Math.min(s, 100), 0)) !== t[e] && n
        );
      }
      ...
      function Y(t) {
        if (p[t]) {
          ...
          0 !== t && (e = b[t - 1]),
            t !== p.length - 1 && (n = b[t]),
            (p[t].style[i.style] = R(e)),
            (p[t].style[i.styleOposite] = R(100 - n));
        }
      }
      ...
      function _(t, e) {
        ...
        (e = void 0 === e || !!e),
          o.forEach(I),
          i.animate && !s && n(v, i.cssClasses.tap, i.animationDuration),
          w.forEach(function (t) {
            X(t, b[t], !0, !1);
          }),
          B(),
      ...
      return (
        o((d = v), i.cssClasses.target),
        0 === i.dir ? o(d, i.cssClasses.ltr) : o(d, i.cssClasses.rtl),
        0 === i.ort
          ? o(d, i.cssClasses.horizontal)
          : o(d, i.cssClasses.vertical),
        (u = t(d, i.cssClasses.base)),
        (function (e, n) {
          (c = []), (p = []).push(C(n, e[0]));
          for (var r = 0; r < i.handles; r++)
            c.push(
              ((s = r),
              (l = void 0),
              (a = t(n, i.cssClasses.origin)),
              t((l = t(a, i.cssClasses.handle)), i.cssClasses.handleTouchArea),
              l.setAttribute("data-handle", s),
              0 === s
                ? o(l, i.cssClasses.handleLower)
                : s === i.handles - 1 && o(l, i.cssClasses.handleUpper),
              a)
            ),
              (w[r] = r),
              p.push(C(n, e[r + 1]));
        ...
        (f = {
          destroy: function () {
            for (var t in i.cssClasses)
              i.cssClasses.hasOwnProperty(t) && s(v, i.cssClasses[t]);
          ...
          updateOptions: function (t, e) {
            ...
            r.forEach(function (e) {
              ...
              (o.spectrum.direction = x.direction),
              (x = o.spectrum),
              (i.margin = o.margin),
              (i.limit = o.limit),
              (i.padding = o.padding),
          ...
          p.forEach(function (t, e) {
            if (!1 !== t && 0 !== e && e !== p.length - 1) {
              var n = c[e - 1],
                r = c[e],
                s = [t];
              o(t, i.cssClasses.draggable),
                h.fixed && (s.push(n.children[0]), s.push(r.children[0])),
        ...
        i.tooltips &&
          ...
          $("update", function (t, e, n) {
            if (m[e]) {
              var r = t[e];
              !0 !== i.tooltips[e] && (r = i.tooltips[e].to(n[e])),
                (m[e].innerHTML = "<span>" + r + "</span>");
            }
          })),
        f
      );
